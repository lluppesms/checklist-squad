...
ALTER TABLE [dbo].[SharingInvite] ADD CONSTRAINT [DF_SharingInvite_Role]      DEFAULT (N'user')    FOR [Role];
GO
ALTER TABLE [dbo].[SharingInvite] ADD CONSTRAINT [DF_SharingInvite_Status]    DEFAULT (N'pending') FOR [Status];
GO
ALTER TABLE [dbo].[SharingInvite] ADD CONSTRAINT [DF_SharingInvite_CreatedAt] DEFAULT (GETDATE())  FOR [CreatedAt];
GO
