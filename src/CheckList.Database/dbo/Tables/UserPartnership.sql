...
ALTER TABLE [dbo].[UserPartnership] ADD CONSTRAINT [DF_UserPartnership_Role]            DEFAULT (N'user')   FOR [Role];
GO
ALTER TABLE [dbo].[UserPartnership] ADD CONSTRAINT [DF_UserPartnership_AutoShareEnabled] DEFAULT (1)         FOR [AutoShareEnabled];
GO
ALTER TABLE [dbo].[UserPartnership] ADD CONSTRAINT [DF_UserPartnership_CreatedAt]        DEFAULT (GETDATE()) FOR [CreatedAt];
GO
