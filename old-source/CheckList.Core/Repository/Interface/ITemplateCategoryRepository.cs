//-----------------------------------------------------------------------
// <copyright file="ITemplateCategoryRepository.cs" company="Luppes Consulting, Inc.">
...
namespace CheckListApp.Data
{
    ...
    public interface ITemplateCategoryRepository
    {
        ...
        IQueryable<TemplateCategory> FindAll(string requestingUserName);
        ...
        /// <returns>Records</returns>
        TemplateCategoryGrid FindGridRecords(string requestingUserName, string searchTxt, int skipNbr, int takeNbr);
        ...
        /// <returns>Records</returns>
        TemplateCategory FindOne(string requestingUserName, int id);
        ...
        /// <returns>Success</returns>
        int Add(string requestingUserName, TemplateCategory templateCategory);
        ...
        /// <param name="templateCategory">Object</param>
        /// <returns>Success</returns>
        bool Save(string requestingUserName, TemplateCategory templateCategory);
        ...
        /// <param name="templateCategory">Object</param>
        /// <returns>Success</returns>
        bool Save(string requestingUserName, int id, TemplateCategory templateCategory);
