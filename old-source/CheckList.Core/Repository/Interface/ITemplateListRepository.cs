//-----------------------------------------------------------------------
// <copyright file="ITemplateListRepository.cs" company="Luppes Consulting, Inc.">
...
namespace CheckListApp.Data
{
    ...
    public interface ITemplateListRepository
    {
        ...
        IQueryable<TemplateList> FindAll(string requestingUserName);
        ...
        /// <returns>Records</returns>
        TemplateListGrid FindGridRecords(string requestingUserName, string searchTxt, int skipNbr, int takeNbr);
        ...
        /// <returns>Records</returns>
        TemplateList FindOne(string requestingUserName, int id);
        ...
        /// <returns>Success</returns>
        int Add(string requestingUserName, TemplateList templateList);
        ...
        /// <param name="templateList">Object</param>
        /// <returns>Success</returns>
        bool Save(string requestingUserName, TemplateList templateList);
        ...
        /// <param name="templateList">Object</param>
        /// <returns>Success</returns>
        bool Save(string requestingUserName, int id, TemplateList templateList);
